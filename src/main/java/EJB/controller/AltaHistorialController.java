 ...
 */
 @Named
 @ViewScoped
public class AltaHistorialController implements Serializable{
    @Inject
    private Cliente cli;    
    @Inject 
    private Mascota pet;    
    ...
    private void setFechaCaso(){
        caso.setFechaCaso(new Date());
    }
